# our phased release cloudlet terraform setup
# this activation is separate state and managed outside of this root module
# this example will be using terraform cloud with a workspace name of phased-release-cloudlet
terraform {
  required_providers {
    akamai = {
